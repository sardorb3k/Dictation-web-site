// // By Sardorb3k
// // https://github.com/sardorb3k/Dictation-web-site
// var timer = document.getElementById("title");
...
// var content_audio = document.getElementById("content_audio");
// var score = 0;
// var myaudio = document.getElementById("audioID");
// var fullname = document.getElementById("name");
//
//
// var action = document.getElementsByName("reg-public");
//
// function stop() {
...
// function start_test() {
// 	alert("Salom")
// 	if (document.getElementById('action_text').checked == true) {
// 		startButton.addEventListener("click", action_text);
// 	}
// 	if (document.getElementById('action_audio').checked == true) {
// 		startButton.addEventListener("click", action_audio);
// 	}
// }
//
//
// var action_text = function () {
//
// 	startWindow.style.display = "none";
//
// 	timer.innerHTML = fullname.value;
// 	timer.style.display = "block";
// 	content_text.style.display = "block";
// 	content_text.style.marginTop = "0px";
//
...
// };
//
// var action_audio = function () {
// 	alert("audio")
// 	startWindow.style.display = "none";
//
// 	timer.innerHTML = "Time Remaining: 60s";
// 	timer.style.display = "block";
// 	content_audio.style.display = "block";
// 	content_audio.style.marginTop = "0px";
//
// 	textArea.addEventListener("keydown", displayTime);
//
// 	generatePassage();
...
// 	myaudio.play();
// };
// // textArea.addEventListener("keydown", audio_play);
//
